...
class GridNode:
	"""
		Objects to define grid nodes of a network
		generators and loads are connected to grid node
		in which the sum of loads and generators represent the electrical parameters of a grid node
	"""
