...
from simplepowerflow.powerflow.utils.create_plot import create_voltage_plot

csv_export_path = "/Users/anjo/Desktop/Coding/Python/PySPFC/simplepowerflow/csv_export"
...
class CSVexport:
    ...
    def export_node_voltage_plot(self, v_mag_data):
        1
        """
        @TODO: not yet customized to time series data
        """
...
def export_data_to_csv(csv_export_path, file_name, data_dict):
    """
    exports data of a dictionary to a csv file that will be saved in a specified csv_export_path
    :param csv_export_path: directory
    :param file_name: unique filename
    :param data_dict: data that will be saved in a csv format
    :return:
    """
